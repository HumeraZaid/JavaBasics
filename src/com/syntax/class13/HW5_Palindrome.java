...
public class HW5_Palindrome {
	...
	public static void main(String[] args) {
        ...
        if(userInput.equalsIgnoreCase(str3.reverse().toString()))
        {
            System.out.println("Your string is a palindrome string.");
        }
        else
        ...
        if(c.equals(b))
        {
            System.out.println(c + " is a palindrome string.");
        }
        else
        {
            System.out.println(c + " is not a palindrome string.");
        }
        ...
        {
            System.out.println(a1 + " is a palindrome string.");
        }
        else
        {
            System.out.println(a1 + " is not a palindrome string.");
        }
